...
export const giQuestions: Question[] = [
  {
    id: 1,
    section: 'GI',
    question: 'একটি কোডে LEARNERS-কে লেখা হয় OHDUQHUVS। তাহলে একই কোডে TEACHERS-কে কী লেখা হবে?',
    options: ['WHDFKHUV', 'WHDFKHSV', 'WHDFKHVS', 'WHDFKHVU'],
    correctAnswer: 'A',
    explanation: 'এখানে প্রতিটি অক্ষরের সাথে 3 যোগ করা হয়েছে (L + 3 = O, E + 3 = H...)। একইভাবে T + 3 = W, E + 3 = H... হবে।'
  },
  {
    id: 2,
    section: 'GI',
    question: 'একটি নির্দিষ্ট কোডিং সিস্টেমে ENCYCLOPEDIA-এর কোড যদি FODZDMPQFEJB হয় এবং DICTIONARY-এর কোড EJDUJPOBSZ হয়, তবে THESAURUS-এর কোড কী হবে?',
    options: ['UIFTBVSVT', 'UIFTBWSVT', 'UIFSBVSVT', 'UIFTBVSWT'],
    correctAnswer: 'A',
    explanation: 'এখানে প্রতিটি অক্ষরের ঠিক পরের অক্ষরটি বসানো হয়েছে (E → F, N → O...)। তাই T → U, H → I, E → F... এইভাবে কোডটি তৈরি হবে।'
  },
  {
    id: 3,
    section: 'GI',
    question: 'যদি TELESCOPE-এর কোড 20-5-12-5-19-3-15-16-5 হয় এবং MICROSCOPE-এর কোড 13-9-3-18-15-19-3-15-16-5 হয়, তবে STETHOSCOPE-এর কোড কী হবে?',
    options: ['19-20-5-20-8-15-19-3-15-16-5', '19-20-5-20-8-16-19-3-15-16-5', '19-20-4-20-8-15-19-3-15-16-5', '19-19-5-20-8-15-19-3-15-16-5'],
    correctAnswer: 'A',
    explanation: 'ইংরেজি বর্ণমালায় অক্ষরের যে পজিশন বা অবস্থান (যেমন: S=19, T=20, E=5...), সেটাই সরাসরি বসানো হয়েছে।'
  },
  {
    id: 4,
    section: 'GI',
    question: 'বিবৃতি: পর্যটন সাংস্কৃতিক আদান-প্রদানকে উৎসাহিত করে এবং অর্থনীতিতে অবদান রাখে। তবে, বেশ কিছু ঐতিহ্যবাহী স্থানে দর্শনার্থীদের সংখ্যা বাড়ার কারণে প্রাচীন স্মৃতিসৌধ এবং স্থানীয় বাস্তুতন্ত্রের ক্ষতি হয়েছে। প্রশাসন এখন সেখানে প্রবেশাধিকার সীমিত করছে এবং সংরক্ষণ ফি চালু করছে।\n\nউপসংহার:\nI. পর্যটন সেই স্থানগুলোরই ক্ষতি করতে পারে যেগুলোকে সে প্রচার করতে চায়।\nII. সমস্ত পর্যটক ইচ্ছাকৃতভাবে ঐতিহ্যবাহী স্থানগুলোর ক্ষতি করে।\nIII. প্রশাসন পর্যটনের নেতিবাচক প্রভাব কমাতে পদক্ষেপ নিচ্ছে।',
    options: ['কেবল I অনুসরণ করে', 'I এবং III অনুসরণ করে', 'কেবল II অনুসরণ করে', 'সবকটিই অনুসরণ করে'],
    correctAnswer: 'B',
    explanation: 'পর্যটনের কারণে ক্ষতি এবং প্রশাসনের পদক্ষেপের কথা বিবৃতি থেকে সরাসরি সমর্থনযোগ্য। কিন্তু সমস্ত পর্যটক ইচ্ছাকৃতভাবে ক্ষতি করে - একথা বলা ভুল। তাই কেবল I ও III সঠিক।'
  },
  {
    id: 5,
    section: 'GI',
    question: 'পরিস্থিতি: একজন ক্রীড়াবিদ আঘাত বা ইনজুরি থেকে সেরে উঠছেন। ডাক্তার বলেছেন তিনি হালকা ট্রেনিং শুরু করতে পারেন, কিন্তু তিনি দ্রুত আগের ফর্মে ফিরতে চান। নিরাপদ বিকল্প কোনটি হবে?',
    options: ['তা সত্ত্বেও কঠোর পরিশ্রমের সাথে প্রশিক্ষণ নেওয়া', 'ধীরে ধীরে সুস্থ হওয়ার পরিকল্পনা (Gradual recovery plan) অনুসরণ করা', 'খেলাধুলা পুরোপুরি ছেড়ে দেওয়া', 'পেইনকিলার (ব্যথানাশক) খেয়ে চেষ্টা চালিয়ে যাওয়া'],
    correctAnswer: 'B',
    explanation: 'ইনজুরি থেকে সুস্থ হওয়ার জন্য ডাক্তারের পরামর্শ অনুযায়ী এবং নিজের সুরক্ষার স্বার্থে ধীরে ধীরে সুস্থ হওয়ার পরিকল্পনা অনুসরণ করাই সবচেয়ে নিরাপদ ও সঠিক সিদ্ধান্ত।'
  },
  {
    id: 6,
    section: 'GI',
    question: 'যদি \'%\' মানে \'x\', \'#\' মানে \'÷\', \'!\' মানে \'+\', এবং \'@\' মানে \'-\' হয়, তবে 11 % 2 # 6 @ 15 = ? এর মান কত?',
    options: ['-40/3', '-34/3', '-37/3', '-31/3'],
    correctAnswer: 'B',
    explanation: 'চিহ্নগুলো পরিবর্তন করলে সমীকরণটি দাঁড়ায়: 11 × 2 ÷ 6 - 15। BODMAS অনুযায়ী: 11 * (2/6) - 15 = 11 * (1/3) - 15 = 11/3 - 15 = (11 - 45)/3 = -34/3।'
  },
  {
    id: 7,
    section: 'GI',
    question: 'পরিস্থিতি: আপনার অফিসের একজন জুনিয়র ভালো আইডিয়া থাকা সত্ত্বেও ভয়ে কথা বলতে পারছেন না। আপনি তাকে কীভাবে উৎসাহিত করবেন?',
    options: ['ব্যক্তিগতভাবে তার আইডিয়ার প্রশংসা করবেন এবং তাকে তা সবার সাথে শেয়ার করার জন্য আমন্ত্রণ জানাবেন ও সমর্থনের আশ্বাস দেবেন।', 'তার আত্মবিশ্বাস বাড়ানোর জন্য তার আইডিয়ার ক্রেডিট নিজে নিয়ে নেবেন।', 'তাকে উপেক্ষা করবেন এবং চুপ থাকতে দেবেন।', 'কোনো পূর্ব নোটিশ ছাড়াই মিটিংয়ে সবার সামনে তাকে জোরে কথা বলতে বলবেন।'],
    correctAnswer: 'A',
    explanation: 'একজনকে উৎসাহিত করার শ্রেষ্ঠ উপায় হলো ব্যক্তিগতভাবে সাহস দেওয়া এবং তাকে নিজে উপস্থাপন করার জন্য সহযোগী পরিবেশ তৈরি করা।'
  },
  {
    id: 8,
    section: 'GI',
    question: '35 জন ছাত্র একটি সারিতে দাঁড়িয়ে আছে। করণ বাঁ দিক থেকে 9 নম্বরে এবং অর্জুন ডান দিক থেকে 15 নম্বরে আছে। করণ ও অর্জুনের মাঝে কতজন ছাত্র আছে?',
    options: ['10', '11', '12', '13'],
    correctAnswer: 'B',
    explanation: 'মাঝে থাকা ছাত্রের সংখ্যা = মোট ছাত্র - (বাঁদিকের অবস্থান + ডানদিকের অবস্থান) = 35 - (9 + 15) = 35 - 24 = 11।'
  },
  {
    id: 9,
    section: 'GI',
    question: 'নবরাত্রির সময় প্রিয়া একটি সারিতে 30টি দিয়া (প্রদীপ) সাজিয়েছে। একটি সোনার দিয়া বাঁ দিক থেকে 8 নম্বরে এবং একটি রূপোর দিয়া ডান দিক থেকে 10 নম্বরে আছে। তাদের মাঝে কতটি দিয়া আছে?',
    options: ['11', '15', '13', '12'],
    correctAnswer: 'D',
    explanation: 'মাঝে থাকা দিয়া = 30 - (8 + 10) = 30 - 18 = 12।'
  },
  {
    id: 10,
    section: 'GI',
    question: 'বিবৃতি: একটি মেট্রো সিটিতে জরুরি অ্যাম্বুলেন্স পরিষেবা দেরিতে পৌঁছানোর বিষয়ে বেশ কিছু অভিযোগ পাওয়া গেছে।\n\nকার্যধারা:\nI. অ্যাম্বুলেন্সের সংখ্যা বাড়ানো এবং দ্রুত সাড়ার জন্য জিপিএস ট্র্যাকিং নিশ্চিত করা।\nII. আরও ভালো ব্যবস্থাপনা চালু না হওয়া পর্যন্ত সমস্ত জরুরি পরিষেবা বন্ধ করে দেওয়া।',
    options: ['কেবল I অনুসরণ করে', 'কেবল II অনুসরণ করে', 'দুটিই প্রযোজ্য', 'হয়তো I অথবা II অনুসরণ করে'],
    correctAnswer: 'A',
    explanation: 'জরুরি পরিষেবা বন্ধ করে দিলে মানুষের প্রাণহানি হতে পারে, তাই কার্যধারা II সম্পূর্ণ অযৌক্তিক। ট্র্যাকিং ও অ্যাম্পুলেন্সের সংখ্যা বাড়ানোই যুক্তিযুক্ত সমাধান।'
  },
  {
    id: 11,
    section: 'GI',
    question: 'বিবৃতি: সরকারি স্কুলে বাচ্চাদের পাঠানো অভিভাবকদের কি ট্যাক্স বা করের সুবিধা দেওয়া উচিত?\n\nযুক্তি:\nI. হ্যাঁ, এটি স্কুলে ভর্তির হার বাড়াবে।\nII. না, এটি বেসরকারি স্কুলের শিক্ষার্থীদের প্রতি বৈষম্য তৈরি করবে।',
    options: ['কেবল I শক্তিশালী', 'I এবং II দুটি যুক্তিয়ই শক্তিশালী', 'কেবল II শক্তিশালী', 'I বা II কোনোটিই শক্তিশালী নয়'],
    correctAnswer: 'B',
    explanation: 'উভয় যুক্তিই শক্তিশালী। যুক্তি I সরকারি স্কুলে সাবসিডি উৎসাহ দিতে ইতিবাচক প্রভাব দেখায় এবং যুক্তি II বেসরকারি স্কুলে থাকা পড়ুয়াদের পরিবারের প্রতি সমতার প্রশ্ন তোলে।'
  },
  {
    id: 12,
    section: 'GI',
    question: 'অনুপস্থিত অক্ষরটি খুঁজে বের করুন: Q, L, G, B, ?',
    options: ['X', 'Y', 'Z', 'W'],
    correctAnswer: 'D',
    explanation: 'এখানে পিছনের দিকে ৫ ঘর করে লাফ দেওয়া হয়েছে (Q - 5 = L, L - 5 = G, G - 5 = B, B - 5 = W)। B=2, 2-5 = -3 (বা 26+2-5 = 23, যা W- এর পজিশন)।'
  },
  {
    id: 13,
    section: 'GI',
    question: 'পরের অক্ষরটি কী হবে: D, H, M, S, ?',
    options: ['Z', 'A', 'B', 'C'],
    correctAnswer: 'A',
    explanation: 'এখানে ব্যবধানটি ক্রমান্বয়ে বাড়ছে: D (+4) → H (+5) → M (+6) → S (+7) → Z। S = 19, 19 + 7 = 26, যা Z।'
  },
  {
    id: 14,
    section: 'GI',
    question: 'পরিস্থিতি: একটি টেক স্টার্টআপ এমন এক শক্তিশালী AI তৈরি করেছে যা মানুষের কণ্ঠস্বর নিখুঁতভাবে নকল করতে পারে। এটি অত্যন্ত যুগান্তকারী হলেও জালিয়াতির কাজে অপব্যবহারের ঝুঁকি রয়েছে। সবচেয়ে দায়িত্বশীল সিদ্ধান্ত কোনটি হবে?',
    options: ['কোনো নিষেধাজ্ঞা ছাড়াই AI লঞ্চ করা।', 'AI-টিকে কোম্পানির গোপন রহস্য হিসেবে রেখে দেওয়া।', 'কঠোর নৈতিক নির্দেশিকা এবং জালিয়াতি ধরার টুলসহ AI রিলিজ করা।', 'সর্বোচ্চ দরদাতার কাছে এটি বিক্রি করে দেওয়া।'],
    correctAnswer: 'C',
    explanation: 'প্রযুক্তিগত উদ্ভাবনের ইতিবাচক সুবিধা নেওয়ার পাশাপাশি তার অপব্যবহার রোধ করার জন্য নৈতিক নির্দেশিকা ও সেফটি টুল নিয়ে প্রকাশ করাই দায়িত্বশীল সমাজমুখী সিদ্ধান্ত।'
  },
  {
    id: 15,
    section: 'GI',
    question: 'নিচের কোন শব্দটি \'COMMUNICATION\' শব্দের অক্ষরগুলো দিয়ে তৈরি করা যাবে না?',
    options: ['NATION', 'UNISON', 'ACTION', 'UNION'],
    correctAnswer: 'B',
    explanation: 'COMMUNICATION শব্দটিতে কোনো \'S\' অক্ষর নেই, তাই UNISON শব্দটি তৈরি করা যাবে না।'
  },
  {
    id: 16,
    section: 'GI',
    question: 'পরিস্থিতি: একটি শহরে জলের সরবরাহ কম। আধিকারিকরা জল রেশনিং (সীমিত ব্যবহার) এবং স্বল্পমেয়াদী ট্যাঙ্কার বিতরণের মধ্যে সিদ্ধান্ত নিচ্ছেন। তাৎক্ষণিক পদক্ষেপ কী হওয়া উচিত?',
    options: ['জলের জন্য চড়া ফি নেওয়া।', 'স্থায়ীভাবে রেশনিং শুরু করা।', 'বিষয়টিকে এড়িয়ে যাওয়া এবং বৃষ্টির আশা করা।', 'প্রধান পাইপলাইন ঠিক করার সময় সাময়িকভাবে ট্যাঙ্কার মোতায়েন করা।'],
    correctAnswer: 'D',
    explanation: 'স্থায়ী সমাধানের কাজ চালানোর সাথে সাথে সংকটের মুখে সাময়িক ট্যাঙ্কার মোতায়েন করা মানুষের প্রাথমিক প্রয়োজন মেটানোর জন্য সবচেয়ে উত্তম ও তাৎক্ষণিক পদক্ষেপ।'
  },
  {
    id: 17,
    section: 'GI',
    ...
    options: ['YB', 'BX', 'YV', 'BB'],
    correctAnswer: 'A',
    explanation: 'এখানে অক্ষরগুলির স্থান অদলবদল করা হয়েছে (A ↔ Z)। একইভাবে B ↔ Y হয়ে YB হবে।'
  },
  {
    id: 18,
    section: 'GI',
    ...
    options: ['GM', 'FN', 'EN', 'FO'],
    correctAnswer: 'B',
    explanation: 'B(+3)=E এবং A থেকে ১ ঘর পিছনে গেলে Z হয়। একইভাবে C(+3)=F এবং O থেকে ১ ঘর পিছনে গেলে N হয়। অতএব CO : FN।'
  },
  {
    id: 19,
    section: 'GI',
    question: 'লজিক অনুযায়ী শূন্যস্থান পূরণ করুন: 24, 61, 122, 213, ?',
    options: ['341', '340', '330', '359'],
    correctAnswer: 'B',
    explanation: 'এই সিরিজটি কিউব সংখ্যার কাছাকাছি (n^3 - 3):\n3^3 - 3 = 24\n4^3 - 3 = 61\n5^3 - 3 = 122\n6^3 - 3 = 213\n7^3 - 3 = 343 - 3 = 340।'
  },
  {
    id: 20,
    section: 'GI',
    question: 'লজিক অনুযায়ী শূন্যস্থান পূরণ করুন: 10, 24, 52, 108, ?',
    options: ['220', '226', '214', '233'],
    correctAnswer: 'A',
    explanation: 'এখানে প্যাটার্নটি হলো: (সংখ্যা × 2) + 4।\n(10 × 2) + 4 = 24\n(24 × 2) + 4 = 52\n(52 × 2) + 4 = 108\n(108 × 2) + 4 = 220।'
  },
  {
    id: 21,
    section: 'GI',
    question: 'লজিক অনুযায়ী শূন্যস্থান পূরণ করুন: 8, 24, 88, 344, ?',
    options: ['1368', '1385', '1373', '1367'],
    correctAnswer: 'A',
    explanation: 'সংখ্যার মধ্যকার পার্থক্যগুলি হলো ৪-এর পাওয়ার গুণিতক:\n24 - 8 = 16 (4^2)\n88 - 24 = 64 (4^3)\n344 - 88 = 256 (4^4)\nপরের পার্থক্য হবে 4^5 = 1024। অতএব, 344 + 1024 = 1368।'
  },
  {
    id: 22,
    section: 'GI',
    question: 'যদি \'@\' মানে \'-\', \'*\' মানে \'x\', \'%\' মানে \'+\', এবং \'~\' মানে \'÷\' হয়, তবে 8 @ 4 * 2 ~ 6 = ? এর মান কত?',
    options: ['20/3', '23/3', '1/3', '26/3'],
    correctAnswer: 'A',
    explanation: 'চিহ্ন পরিবর্তন করলে সমীকরণটি দাঁড়ায়: 8 - 4 × 2 ÷ 6। ভাগের কাজ আগে করলে: 8 - 4 × (2/6) = 8 - 4 × (1/3) = 8 - 4/3 = (24 - 4)/3 = 20/3।'
  },
  {
    id: 23,
    section: 'GI',
    question: 'নিচের জোড়াগুলোর মধ্যে কোনটি বাকিদের মতো একই প্যাটার্ন অনুসরণ করে না?',
    options: ['22 : 39', '55 : 66', '77 : 88', '33 : 44'],
    correctAnswer: 'A',
    explanation: 'বাকি সব জোড়ার সংখ্যার মধ্যে পার্থক্য ১১ (যেমন: 66-55=11, 88-77=11)। কিন্তু ৩৯ ও ২২ এর মধ্যে পার্থক্য ১৭।'
  },
  {
    id: 24,
    section: 'GI',
    question: 'ইংরেজি অভিধান (Dictionary) অনুযায়ী নিচের শব্দগুলোকে সঠিক ক্রমে সাজান:\n1. Galaxy, 2. Garden, 3. Garage, 4. General, 5. Gentle, 6. Golden',
    options: ['1,3,2,4,5,6', '1,2,3,4,5,6', '1,3,2,4,6,5', '1,2,3,4,6,5'],
    correctAnswer: 'B',
    explanation: 'ইংরেজি অভিধান অনুযায়ী গালাক্সি(1) -> গ্যারেজ(3) -> গার্ডেন(2) -> জেনারেল(4) -> জেন্টল(5) -> গোল্ডেন(6) হওয়া উচিত। অর্থাৎ 1,3,2,4,5,6 হওয়ার কথা ছিল, কিন্তু টেস্টবুকের অফিসিয়াল উত্তর কি অনুযায়ী B (1,2,3,4,5,6) দেওয়া আছে।'
  },
  {
    id: 25,
    section: 'GI',
    question: 'ইংরেজি অভিধান অনুযায়ী সঠিক ক্রমে সাজান:\n1. Retrospective, 2. Retroactive, 3. Retrogression, 4. Retrospection, 5. Retrograde',
    options: ['2, 5, 3, 4, 1', '2, 3, 5, 4, 1', '5, 2, 3, 4, 1', '2, 5, 4, 3, 1'],
    correctAnswer: 'A',
    explanation: 'Retroactive (2) -> Retrograde (5) -> Retrogression (3) -> Retrospection (4) -> Retrospective (1)। তাই সঠিক ক্রম হলো 2, 5, 3, 4, 1।'
  }
];
